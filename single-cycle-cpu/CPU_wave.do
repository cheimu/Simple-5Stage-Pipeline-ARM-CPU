...
add wave -noupdate -radix decimal {/CPU_testbench/dut/computation_unit/register_file/eachDff[0]/dff/dataOut}
...
add wave -noupdate {/CPU_testbench/dut/computation_unit/register_file/eachDff[5]/dff/dataOut}
add wave -noupdate {/CPU_testbench/dut/computation_unit/register_file/eachDff[6]/dff/dataOut}
add wave -noupdate {/CPU_testbench/dut/computation_unit/register_file/eachDff[7]/dff/dataOut}
...
add wave -noupdate -radix decimal {/CPU_testbench/dut/computation_unit/register_file/eachDff[10]/dff/dataOut}
add wave -noupdate {/CPU_testbench/dut/computation_unit/register_file/eachDff[11]/dff/dataOut}
...
add wave -noupdate {/CPU_testbench/dut/computation_unit/disk/mem[0]}
add wave -noupdate {/CPU_testbench/dut/computation_unit/disk/mem[1]}
add wave -noupdate {/CPU_testbench/dut/computation_unit/disk/mem[2]}
add wave -noupdate {/CPU_testbench/dut/computation_unit/disk/mem[3]}
add wave -noupdate {/CPU_testbench/dut/computation_unit/disk/mem[4]}
add wave -noupdate {/CPU_testbench/dut/computation_unit/disk/mem[5]}
add wave -noupdate {/CPU_testbench/dut/computation_unit/disk/mem[6]}
add wave -noupdate {/CPU_testbench/dut/computation_unit/disk/mem[7]}
add wave -noupdate {/CPU_testbench/dut/computation_unit/disk/mem[8]}
add wave -noupdate {/CPU_testbench/dut/computation_unit/disk/mem[9]}
...
WaveRestoreCursors {{Cursor 1} {2418554578 ps} 0}
